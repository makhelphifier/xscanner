...
GongYTabWidget::GongYTabWidget(QWidget *parent)
    : QTabWidget(parent), m_opacity(1.0),m_font("Microsoft YaHei")
{
    setupTabs();
...
void GongYTabWidget::createXrayGroup(QVBoxLayout* layout)
{
    ...
    QLineEdit* pVolCurrentLineEdit = new QLineEdit();
    pVolCurrentLineEdit->setFont(m_font);
    QLineEdit* pVolTargetLineEdit = new QLineEdit();
    pVolTargetLineEdit->setFont(m_font);
    pvolFormLayout->addRow(tr("Current:"),pVolCurrentLineEdit);
    pvolFormLayout->addRow(tr("Target:"),pVolTargetLineEdit);
    ...
    QLineEdit* pCurrentCurrentLineEdit = new QLineEdit();
    pCurrentCurrentLineEdit->setFont(m_font);
    QLineEdit* pCurrentTargetLineEdit = new QLineEdit();
    pCurrentTargetLineEdit->setFont(m_font);
    pcurrentFormLayout->addRow(tr("Current"),pCurrentCurrentLineEdit);
    pcurrentFormLayout->addRow(tr("Target"),pCurrentTargetLineEdit);
    ...
    QPushButton *pButtonXon = new QPushButton(tr("XON"));
    pBtnsLayout->addWidget(pButtonXon);
    pBtnsLayout->addStretch();
    QPushButton *pButtonXoff = new QPushButton(tr("XOFF"));
    pBtnsLayout->addWidget(pButtonXoff);
    pBtnsLayout->addStretch();
    ...
    QCheckBox* pXray = new QCheckBox(tr("XRay"));
    QCheckBox* pWarmUp = new QCheckBox(tr("Warm Up"));
    QCheckBox* pInterLock = new QCheckBox(tr("Inter lock"));
    QCheckBox* pConnect = new QCheckBox(tr("Connect"));
    pStatesLayout->addWidget(pXray);
    pStatesLayout->addWidget(pWarmUp);
    pStatesLayout->addWidget(pInterLock);
    pStatesLayout->addWidget(pConnect);
