...
#define Evt_IdcActiveRegionData	2017 // Return IDC active region selection
...
#define Evt_IdcNetworkInstability	2032 // Notify user current IDC function network instability
