...
class LimitableAutoCommandEventSink :
	public virtual EventSinkBase,
	public ILimitableAutoCommandCOMEvents
{
private:
	static ULONG eventSinkID;
	static const ULONG eventSinkIDOffset = 1100000;

public:
	LimitableAutoCommandEventSink()
		: EventSinkBase()
	{
		eventSinkID++;
	...
	{
		if(IsEqualGUID(riid, __uuidof(ILimitableAutoCommandCOMEventsPtr)))
	   {
		  this->AddRef();
		  *ppvObject = this;
		  return S_OK;
		  ...
		  DISPPARAMS *pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, UINT *puArgErr) 
	{
		switch(dispIdMember)
		{
			...
			case DispIds_LimitedKVMinChanged:
			{
				OnLimitedKVMinChanged();
				break;
			}
			default:
			{
